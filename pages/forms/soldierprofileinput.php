<?php
 ...
 $var1=1;
 $SBAnum = "SELECT ss FROM cache WHERE id='$var1'";
  $result1 = mysqli_query($conn, $SBAnum);
...
if(isset($_POST['update'])){
  ...
  $ssql = "UPDATE firer SET Name='$fname', DOB='$fdob', Gender='$fgender', Religion='$freligion', Cell='$fphn', Village='$fvill', PO='$fpo', PS='$fps', Dist='$fdist', NID='$fnid', Unit='$funit', Company='$companyy' WHERE id='$SBA'";
  ...
  $check = getimagesize($_FILES["Image"]["tmp_name"]);
    if($check !== false){
        ...
        $query="UPDATE firer SET Image='$imgContent' WHERE id='$SBA'";
 ...
 //display
 $disp = "SELECT * FROM firer WHERE id='$SBA'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="soldierprofileinput.php" method="post" enctype="multipart/form-data">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
