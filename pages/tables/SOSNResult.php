...
<head>
  ...
  <title>Zero Weapon | Bullet Impression Data</title>
...
<header class="main-header">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Bullet Impression Data
        <small>Data Table</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Output</a></li>
        <li class="active">Bullet Impression Data</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Bullet Impression Data</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <?php
                    $disp = "SELECT st.id, f.Name, st.Target1A, st.Target2A, st.Target3A, st.Total FROM SOSNTable st, firer f WHERE f.id=st.id AND f.Company='$userCom'";
                      $results = mysqli_query($conn, $disp);
                      if (mysqli_num_rows($results) > 0) {
                        while($rows = mysqli_fetch_assoc($results)) {
                          if($currAT=='2' && $rows["id"]==$currBA){
                            echo "<tr>";
                            echo "<td>" .$rows["id"]. "</td>"; 
                            echo "<td>" .$rows["Name"]. "</td>";
                            echo "<td>" .$rows["Target1A"]. "</td>";
                            echo "<td>" .$rows["Target2A"]. "</td>";
                            echo "<td>" .$rows["Target3A"]. "</td>";
