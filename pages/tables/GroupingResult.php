            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <?php
                    $disp = "SELECT gt.id, f.Name, gt.Result, et.ErrorName, et.CorrectionMethod FROM GroupingTable gt, ErrorTable et, firer f WHERE f.id=gt.id AND gt.ErrorID=et.ErrorID AND f.Company='$userCom'";
                      ...
                      if (mysqli_num_rows($results) > 0) {
                        while($rows = mysqli_fetch_assoc($results)) {
                          if($currAT=='2' && $rows["id"]==$currBA){
                            ...
                            echo "<td>" .$rows["ErrorName"]. "</td>";
                            echo "<td>" .$rows["CorrectionMethod"]. "</td>";
                            echo "</tr>";
                          }
                          if($currAT=='1'){
                            echo "<tr>";
